 ...
 */
public class BatchAddMutation<K extends Comparable<K>, P extends Persistable<K>>
    implements RangeMutation<K,P>
{
     ...
     * CTOR
     */
    public BatchAddMutation(String tableName, List<P> data)
    {
        super();
