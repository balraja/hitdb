...
/**
 * Defines the contract for response generated by the facade when the
 * DBOperation is successfully applied to the database.
 *
 * @author Balraja Subbiah
 */
public class DBOperationResponse
{
    private final DBOperation myDbOperation;
     ...
     * CTOR
     */
    public DBOperationResponse(DBOperation dbOperation, Object result)
    {
        super();
