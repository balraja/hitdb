...
public class LongKeySpace implements KeySpace<Long>
{
    ...
    {
        return BigInteger.valueOf((myMaxValue - myMinValue) + 1);
    }
     ...
     */
    @Override
    public Long nextAtOffset(Long currentValue, BigInteger offset)
    {
        if (myMaxValue - currentValue < offset.longValue()) {
            long changedOffset = 
                offset.longValue() - (myMaxValue - currentValue);
            return Long.valueOf(myMinValue + changedOffset);
        }
        return Long.valueOf(currentValue + offset.longValue());
    }
