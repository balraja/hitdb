...
schema_name         : tmpName=ID {tmpName.getText().length() <= 64}? {};
table_name          : tmpName=ID {tmpName.getText().length() <= 64}? {};
engine_name         : tmpName=ID {tmpName.getText().length() <= 64}? {};
column_name         : tmpName=ID {tmpName.getText().length() <= 64}? {};
view_name           : tmpName=ID {tmpName.getText().length() <= 64}? {};
parser_name         : tmpName=ID {tmpName.getText().length() <= 64}? {};
index_name          : tmpName=ID {tmpName.getText().length() <= 64}? {};
partition_name          : tmpName=ID {tmpName.getText().length() <= 64}? {};
partition_logical_name      : tmpName=ID {tmpName.getText().length() <= 64}? {};
constraint_symbol_name      : tmpName=ID {tmpName.getText().length() <= 64}? {};
foreign_key_symbol_name     : tmpName=ID {tmpName.getText().length() <= 64}? {};
collation_name          : tmpName=ID {tmpName.getText().length() <= 64}? {};
event_name          : tmpName=ID {tmpName.getText().length() <= 64}? {};
user_name           : tmpName=ID {tmpName.getText().length() <= 64}? {};
function_name           : tmpName=ID {tmpName.getText().length() <= 64}? {};
procedure_name          : tmpName=ID {tmpName.getText().length() <= 64}? {};
server_name         : tmpName=ID {tmpName.getText().length() <= 64}? {};
wrapper_name            : tmpName=ID {tmpName.getText().length() <= 64}? {};
alias               : ( AS_SYM )? tmpName=ID {tmpName.getText().length() <= 64}? {};
